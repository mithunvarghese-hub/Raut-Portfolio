...
export default function OrbBackground({ hue = 330, hoverIntensity = 0.5, rotateOnHover = true, forceHoverState = false }) {
  ...
  useEffect(() => {
    ...
    // Mouse movement relative to center of the parent section
